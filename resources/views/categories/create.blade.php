            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mt-3">
                        <label for="input_category_title" class="fw-bold">
                    ...
                    <!-- slug -->
                    <div class="form-group mt-3">
                        <label for="input_category_slug" class="fw-bold">
                    ...
                    <!-- thumbnail -->
                    <div class="form-group mt-3">
                        <label for="input_category_thumbnail" class="fw-bold">
                    ...
                    <!-- parent_category -->
                    <div class="form-group mt-3">
                        <label for="select_category_parent" class="fw-bold">
                    ...
                    <!-- description -->
                    <div class="form-group mt-3">
                        <label for="input_category_description" class="fw-bold">
                    ...
                    <div class="text-end mt-3">
                        <a class="btn btn-secondary px-4" href="{{ route('categories.index') }}">
